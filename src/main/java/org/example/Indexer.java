...
public class Indexer {
    ...
    Indexer(String index_directory_path) throws IOException, TikaException, SAXException{
        ...
        CharArraySet stopwords_updated = stopwords_List();
    ...
    public static CharArraySet stopwords_List(){
        ...
        try {
            File sw_file = new File(stopwords_path.toString());
    ...
    private Document create_Doc(String file_content, String file_name, String file_path) throws IOException{
